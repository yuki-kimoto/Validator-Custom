...
C<parameter name>, C<options>, C<constraint function>, C<constrint argument>
...
if the paramter value is invalid or the paramter name is missing in the data.
...
You can see default constraint functions L<Validator::Custom/"CONSTRAINTS">.
...
Constraint function receive a scalar value and
return boolean value which check if the value is valid.

Constraint function also receive argument of constraint function as second argument
