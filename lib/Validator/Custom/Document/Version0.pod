...
Validator::Custom version 0.xx documentation

=head1 DESCRIPTION

This is Validator::Custom version 0.xx documentation.
This is deprecated syntax for backword compatibitily.
...
Validator::Custom validate HTML form data easy and flexibly.
...
Please see "RULE" about rule syntax.
...
C<validate()> return Validator::Custom::Result object.
...
C<messages_to_hash()> is already explained in /"1. Basic"
...
in the POD of Validator::Custom::Result
...
You can create C<create_rule> method of Validator::Custom.
...
Validator::Custom inherits all methods from L<Object::Simple>
...
(or Validator::Custom::Rule object, this is EXPERIMENTAL).
...
Validator::Custom::Result> inherits all methods from L<Object::Simple>
and implements the following new ones.
